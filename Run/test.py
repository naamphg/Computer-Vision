...
while count < 14:
    ...
    image = cv2.imread("D:/HCMUT/HK191/ComputerVision/BTL/Data/testCar/{}.jpg".format(count))
    start = time.time()
    Width = image.shape[1]
    ...
    for out in outs:
        for detection in out:
            ...
            if confidence > 0:
                ...
                scorepltb = scorepltb + float(confidence)
                scoretb = scoretb + detection[4]
...
# apply non-max suppression
    ...
    for j in indices:
        ...
        for i in range(len(pn)):
            ...
            k = k + 18
print("Number plate: ", coount)
print("OjectScore avg: ", scoretb/15)
print("PlateScore avg: ", scorepltb/15)
print("Time avg: ", timetb)
